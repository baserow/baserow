    ...
    <div v-if="small" class="service-form__filter-buttons">
      ...
      >
        ...
        <span class="header__filter-name">{{
          $tc('serviceFormRefinements.filterTabTitle', filterCount, {
            count: filterCount,
          })
        }}</span>
      </a>
      ...
      >
        ...
        <span class="header__filter-name">{{
          $tc('serviceFormRefinements.sortTabTitle', sortCount, {
            count: sortCount,
          })
        }}</span>
      </a>
      ...
      >
        <div class="service-form__context-content">
          <span class="service-form__context-title">
            {{ $tc('serviceFormRefinements.filterTabTitle', 0, { count: 0 }) }}
          </span>
      ...
      >
        <div class="service-form__context-content">
          <span class="service-form__context-title">
            {{ $tc('serviceFormRefinements.sortTabTitle', 0, { count: 0 }) }}
          </span>
      ...
      <div class="col col-12">
        <Tabs>
          <Tab
            v-if="showFilter"
            :title="
              $tc('serviceFormRefinements.filterTabTitle', 0, {
                count: 0,
              })
            "
          ...
          <Tab
            v-if="showSort"
            :title="
              $tc('serviceFormRefinements.sortTabTitle', 0, {
                count: 0,
              })
            "
