...
const envMapping = {
  ...
  BASEROW_DISABLE_PUBLIC_URL_CHECK: 'NUXT_PUBLIC_BASEROW_DISABLE_PUBLIC_URL_CHECK',
  ...
  BASEROW_MAX_IMPORT_FILE_SIZE_MB: 'NUXT_PUBLIC_BASEROW_MAX_IMPORT_FILE_SIZE_MB',
  ...
  BASEROW_MAX_SNAPSHOTS_PER_GROUP: 'NUXT_PUBLIC_BASEROW_MAX_SNAPSHOTS_PER_GROUP',
...
if (
  ...
  const { parseHostnamesFromUrls } = await import(
    './modules/core/utils/url.js'
  )
  const hostnames = parseHostnamesFromUrls(process.env.BASEROW_EXTRA_PUBLIC_URLS)
  process.env.NUXT_PUBLIC_EXTRA_PUBLIC_WEB_FRONTEND_HOSTNAMES =
