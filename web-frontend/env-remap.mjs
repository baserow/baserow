...
const envMapping = {
  ...
  BASEROW_DASHBOARD_DATA_SOURCE_DISPATCH_CONCURRENCY:
    'NUXT_PUBLIC_BASEROW_DASHBOARD_DATA_SOURCE_DISPATCH_CONCURRENCY',
  ...
  BASEROW_AUTOMATION_WORKFLOW_RESPONSE_TIMEOUT_MAX_SECONDS:
    'NUXT_PUBLIC_AUTOMATION_WORKFLOW_RESPONSE_TIMEOUT_MAX_SECONDS',
