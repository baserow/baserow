...
class LongTextFieldType(CollationSortMixin, FieldType):
    ...
    def prepare_value_for_db(self, instance, value):
        ...
        value = validate_external_image_protocols(value)
    ...
    def set_import_serialized_value(
        ...
        if content and field.long_text_enable_rich_text:
            content = validate_external_image_protocols(content)
            ...
            # to the stored `![alt][name]` form, like the input serializer does.
