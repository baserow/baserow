...
class ViewRows(CreatedAndUpdatedOnMixin, models.Model):
    ...
    @classmethod
    def delete_for_views(cls, views: list[View]):
        """
        Deletes ViewRows objects for the given views.

        :param views: The views for which to delete ViewRows objects.
        """

        ViewRows.objects.filter(view__in=views).delete()
