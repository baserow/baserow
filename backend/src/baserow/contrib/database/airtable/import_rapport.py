...
class AirtableImportRapport:
    def __init__(self):
        self.items = []

    def add_failed(self, name, category, table, message):
        self.items.append(ImportRapportFailedItem(name, category, table, message))
