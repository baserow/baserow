...
BASEROW_WEBHOOKS_ALLOW_PRIVATE_ADDRESS = str_to_bool(
    os.getenv("BASEROW_WEBHOOKS_ALLOW_PRIVATE_ADDRESS") or "false"
)
...
INTEGRATIONS_ALLOW_PRIVATE_ADDRESS = str_to_bool(
    os.getenv("BASEROW_INTEGRATIONS_ALLOW_PRIVATE_ADDRESS") or "false"
)
