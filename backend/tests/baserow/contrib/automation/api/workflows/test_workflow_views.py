...
def test_create_workflow(api_client, data_fixture):
    ...
    name = "Foo automation"
    url = reverse(
        "api:automation:automation_id:workflows:create", kwargs={"automation_id": automation.id}
    )
...
def test_create_workflow_automation_does_not_exist(api_client, data_fixture):
    ...
    url = reverse("api:automation:automation_id:workflows:create", kwargs={"automation_id": 1234})
    response = api_client.post(
        url,
        {"name": "test"},
        format="json",
...
def test_update_workflow(api_client, data_fixture):
    ...
    url = reverse("api:automation:workflows:automation_workflow", kwargs={"workflow_id": workflow.id})
...
def test_update_workflow_does_not_exist(api_client, data_fixture):
    ...
    url = reverse("api:automation:workflows:automation_workflow", kwargs={"workflow_id": 9999})
    response = api_client.patch(
...
def test_update_workflow_duplicate_name(api_client, data_fixture):
    ...
    url = reverse("api:automation:workflows:automation_workflow", kwargs={"workflow_id": workflow_2.id})
    response = api_client.patch(
        url,
        {"name": workflow.name},
        format="json",
...
def test_order_workflows(api_client, data_fixture):
    ...
    url = reverse(
        "api:automation:automation_id:workflows:order", kwargs={"automation_id": automation.id}
    )
    response = api_client.post(
        url,
...
def test_order_workflows_automation_does_not_exist(api_client, data_fixture):
    ...
    url = reverse("api:automation:automation_id:workflows:order", kwargs={"automation_id": 1234})
    response = api_client.post(
        url,
        {"workflow_ids": [workflow_2.id, workflow_1.id]},
        format="json",
...
def test_delete_workflow_does_not_exist(api_client, data_fixture):
    ...
    url = reverse("api:automation:workflows:automation_workflow", kwargs={"workflow_id": 1234})
    response = api_client.delete(
        url,
        format="json",
        HTTP_AUTHORIZATION=f"JWT {token}",
