...
from baserow.contrib.automation.workflows.signals import automation_workflow_published
...
def test_clears_http_trigger_error_cache_when_workflow_is_published(
    ...
    for simulate in [True, False]:
        ...
        automation_workflow_published.send(None, user=None, workflow=node.workflow)
