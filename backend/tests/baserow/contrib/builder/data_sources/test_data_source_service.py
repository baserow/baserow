...
def test_create_data_source_with_service_type_for_different_dispatch_type(
    ...
    assert not service_type.can_be_dispatched_by(DispatchTypes.DISPATCH_DATA_SOURCE)
...
def test_update_data_source_with_service_type_for_different_dispatch_type(
    ...
    assert not new_service_type.can_be_dispatched_by(DispatchTypes.DISPATCH_DATA_SOURCE)
