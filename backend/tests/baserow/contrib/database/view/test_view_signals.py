...
@pytest.mark.django_db
def test_rows_entered_and_exited_view_are_called_when_rows_updated(data_fixture):
    user = data_fixture.create_user()
...
@pytest.mark.django_db
def test_rows_entered_and_exited_view_are_called_when_rows_created_or_deleted(
    data_fixture,
):
    user = data_fixture.create_user()
    table_a, table_b, link_a_to_b = data_fixture.create_two_linked_tables()
...
@pytest.mark.django_db
def test_rows_entered_and_exited_view_are_called_when_view_filters_change(
    data_fixture,
):
    user = data_fixture.create_user()
...
@pytest.mark.django_db
def test_rows_entered_and_exited_view_are_called_when_view_filter_groups_change(
    data_fixture,
):
    user = data_fixture.create_user()
    table_a = data_fixture.create_database_table(user=user)
...
@pytest.mark.django_db
def test_rows_entered_and_exited_view_are_called_when_fields_change(
    data_fixture,
):
    user = data_fixture.create_user()
    table_a = data_fixture.create_database_table(user=user)
...
@pytest.mark.django_db
def test_rows_entered_and_exited_view_with_periodic_fields_updates(data_fixture):
    user = data_fixture.create_user()
...
def test_rows_entered_and_exited_view_when_time_sensitive_filters_are_used(
    data_fixture,
):
    user = data_fixture.create_user()
