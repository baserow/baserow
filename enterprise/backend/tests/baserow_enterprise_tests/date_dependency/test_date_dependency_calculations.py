...
def test_date_dependency_calculator_field_changed(
    ...
    """
    Test if DateCalculator.field_changed() detects field value
    changes correctly.
    """
    ...
    calc = DateCalculator(old_values, new_values, False)
    out = []
