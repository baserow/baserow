...
from baserow_enterprise.ai_assistant.nodes.base import AssistantNode
from baserow_enterprise.ai_assistant.types import (
    AssistantState,
    HumanMessage,
    PartialAssistantState,
)
from baserow_enterprise.ai_assistant.utils.helpers import find_last_message_of_type
...
class TitleGeneratorNode(AssistantNode):
    def run(
        ...
        self.chat.title = title[: AiAssistantChat.TITLE_MAX_LENGTH].strip().capitalize()
        self.chat.save()
