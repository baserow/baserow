...
def setup(settings):
    ...
    settings.AGENT_APPLICATION_TRIGGER_RATE_LIMIT_PER_MINUTE = int(
        os.getenv("BASEROW_AGENT_APPLICATION_TRIGGER_RATE_LIMIT_PER_MINUTE", "") or 10
    )
    settings.AGENT_APPLICATION_CHAT_HISTORY_MAX_DAYS = int(
        os.getenv("BASEROW_AGENT_APPLICATION_CHAT_HISTORY_MAX_DAYS", "") or 30
    )
    settings.AGENT_APPLICATION_CHAT_HISTORY_MAX_ENTRIES = int(
        os.getenv("BASEROW_AGENT_APPLICATION_CHAT_HISTORY_MAX_ENTRIES", "") or 200
    )
    settings.AGENT_APPLICATION_CHAT_CLEANUP_INTERVAL_MINUTES = int(
        os.getenv("BASEROW_AGENT_APPLICATION_CHAT_CLEANUP_INTERVAL_MINUTES", "") or 60
    )
    settings.AGENT_APPLICATION_CHAT_STUCK_TIMEOUT_MINUTES = int(
        os.getenv("BASEROW_AGENT_APPLICATION_CHAT_STUCK_TIMEOUT_MINUTES", "") or 30
    )
